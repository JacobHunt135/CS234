...
public class Main  {
        ...
        if (scan.hasNextInt()){
            ...
            switch(user_input){
                case CHOICE_MENU_STORE:
                    Store.setCurrentStaff(currentStaff);
                    Store.menu();
                    break;
                case CHOICE_MENU_PROFILE:
                    Profiles.currentStaff = currentStaff;
                    Profiles.menu();
                    break;
    ...
    public static void main(String[] args) {
        // debug -- staff should be loaded from somewhere i believe? maybe from profile?
        Staff staff = new Staff(0, "Name", "Position", 12);
        currentStaff = staff;
